...
class Tank_auth
{
	...
	{
		return $this->ci->session->userdata('user_profile');
	}

	/**
	 * Get Interprete asociado
	 *
	 * @return	string
	 */
	function get_user_inte_id()
	{
		return $this->ci->session->userdata('inte_id');
	}
